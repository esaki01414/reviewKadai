...
<body>
    ...
    <div class="kana-inputs">
        <div>
            <label for="last-name-kana"><b>姓(カタカナ)</b></label>
            <input type="text" id="last-name-kana" name="user_first_kana" placeholder="セイを入力" required>
        </div>
        <div>
            <label for="first-name-kana"><b>名(カタカナ)</b></label>
            <input type="text" id="first-name-kana" name="user_last_kana" placeholder="メイを入力" required>
        </div>
    </div>
    <br>
    ...
    <input type="text" id="city" name="user_address" placeholder="市区町村名を入力" required><br>
    
    <label for="street-address">番地・ビル名</label>
    <input type="text" id="street-address" name="user_home_number" placeholder="番地・ビル名を入力" required><br>
    
    <label for="phone-number">電話番号</label>
    <input type="tel" id="phone-number" name="user_phone" placeholder="000-0000-0000" pattern="\d{3}-\d{4}-\d{4}" required><br>
    
    <button type="submit" class="register-btn">更新確定</button>
